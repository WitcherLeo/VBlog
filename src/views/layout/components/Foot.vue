<template>
	<div style="border-top: 1px #e1e4e8 solid !important;padding: 45px 0px 45px 0px;">
		<el-row>
			<el-col :span="10">
				<div>
					© 2023 GitHub-WitcherLeo&emsp;&emsp;
					<a href="https://github.com/WitcherLeo" target="_blank">Profile</a>&emsp;&emsp;
					<a href="https://github.com/WitcherLeo/VBlog" target="_blank">VBlog</a>
				</div>
			</el-col>
			<el-col :span="4">
				<div style="text-align: center;font-size: 18px">
					<i class="el-icon-location-outline">ChengDu China</i>
				</div>
			</el-col>
			<el-col :span="10">
